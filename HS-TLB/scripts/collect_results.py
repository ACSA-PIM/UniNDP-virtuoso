...
directories = [
    # '../CPU-cuckoo-potm-1K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-2K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-4K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-16K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-32K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-64K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-128K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-256K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-1K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-2K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-4K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-16K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-32K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-64K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-128K/{}'.format(core_configuration),
    # '../CPU-cuckoo-potm-virtualized-256K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-1K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-2K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-4K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-16K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-32K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-64K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-128K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-virtualized-256K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-1K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-2K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-4K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-16K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-32K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-64K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-128K/{}'.format(core_configuration),
    # '../CPU-HBM-cuckoo-potm-256K/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-4K-virtualized/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-16K-virtualized/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-32K-virtualized/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-64K-virtualized/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-128K-virtualized/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-256K-virtualized/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-4K/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-16K/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-32K/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-64K/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-128K/{}'.format(core_configuration),
    # '../CPU-HBM-L2T-256K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-4K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-16K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-32K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-64K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-128K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-256K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-virtualized-4K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-virtualized-16K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-virtualized-32K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-virtualized-64K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-virtualized-128K/{}'.format(core_configuration),
    # '../CPU-HBM-potm-virtualized-256K/{}'.format(core_configuration),
    # '../CPU-L2T-4K/{}'.format(core_configuration),
    # '../CPU-L2T-16K/{}'.format(core_configuration),
    # '../CPU-L2T-32K/{}'.format(core_configuration),
    # '../CPU-L2T-64K/{}'.format(core_configuration),
    # '../CPU-L2T-128K/{}'.format(core_configuration),
    # '../CPU-L2T-256K/{}'.format(core_configuration),
    # '../CPU-L2T-4K-virtualized/{}'.format(core_configuration),
    # '../CPU-L2T-16K-virtualized/{}'.format(core_configuration),
    # '../CPU-L2T-32K-virtualized/{}'.format(core_configuration),
    # '../CPU-L2T-64K-virtualized/{}'.format(core_configuration),
    # '../CPU-L2T-128K-virtualized/{}'.format(core_configuration),
    # '../CPU-L2T-256K-virtualized/{}'.format(core_configuration),
    # '../CPU-potm-4K/{}'.format(core_configuration),
    # '../CPU-potm-16K/{}'.format(core_configuration),
    # '../CPU-potm-32K/{}'.format(core_configuration),
    # '../CPU-potm-64K/{}'.format(core_configuration),
    # '../CPU-potm-128K/{}'.format(core_configuration),
    # '../CPU-potm-256K/{}'.format(core_configuration),
    # '../CPU-potm-4K-virtualized/{}'.format(core_configuration),
    # '../CPU-potm-16K-virtualized/{}'.format(core_configuration),
    # '../CPU-potm-32K-virtualized/{}'.format(core_configuration),
    # '../CPU-potm-64K-virtualized/{}'.format(core_configuration),
    # '../CPU-potm-128K-virtualized/{}'.format(core_configuration),
    # '../CPU-potm-256K-virtualized/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-4K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-16K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-32K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-64K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-128K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-256K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-virtualized-4K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-virtualized-16K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-virtualized-32K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-virtualized-64K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-virtualized-128K/{}'.format(core_configuration),
    '../CPU-HBM-potm-HS-virtualized-256K/{}'.format(core_configuration)
]

output_file = 'output_HBM_potm_HS_{}.csv'.format(core_configuration)
frequency_ghz = 2.6
...
def calculate_CSTLB_miss_rate(data):
    access_time = 0
    for line in data.splitlines():
        if line.startswith('cuckoo_potm_tlb.access'):
            access_time = int(line.split('=')[1].split(',')[0].strip())
        if line.startswith('cuckoo_potm_tlb.miss'):
            miss_time = int(line.split('=')[1].split(',')[0].strip())
    if access_time == 0:
        return 'N/A'
    return miss_time / access_time
    ...
    for subdir in ['bc', 'bfs', 'cc', 'dlrm', 'gc', 'gen', 'pr', 'rnd', 'sssp', 'tc', 'xs']:
        ...
        if os.path.exists(out_path):
            with open(out_path, 'r') as file:
                ...
                cstlb_miss_rate = calculate_CSTLB_miss_rate(data)
                cstlb_MPKI = calculate_CSTLB_MPKI(data)
