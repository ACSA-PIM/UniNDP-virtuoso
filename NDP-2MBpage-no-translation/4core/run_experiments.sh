...
config=/root/codes/Victima/sniper/config/UniNDP/NDP/baseline_NDP_4core_no_translation.cfg
...
run_and_notify() {
    ...
    (cd "$dir" && $sniper -c $config -g --perf_model/alloc_manager/large_page_percentage=100 -s stop-by-icount:2000000000 --genstats --traces=${trace},${trace},${trace},${trace} && echo "$dir completed") &
}
