...
config=/root/codes/Victima/sniper/config/UniNDP/NDP/baseline_NDP_8core_no_translation_hbm.cfg
...
run_and_notify() {
    ...
    (cd "$dir" && $sniper -c $config -s stop-by-icount:1500000000 --traces=${trace},${trace},${trace},${trace},${trace},${trace},${trace},${trace} && echo "$dir completed") &
}
